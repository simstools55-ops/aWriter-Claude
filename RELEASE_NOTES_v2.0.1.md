...
- Added terminology/unit consistency validation.
- Split publication state into `publishable_public_ok_changes` and `has_user_decision_changes`.
- Contract format remains `SIMS_FEEDBACK_V2`, contract version remains `4.2`.
